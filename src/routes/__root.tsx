  ...
  head: () => ({
    meta: [
      ...
      { title: "Smart Gen School — Empowering Young Minds to Build Tomorrow" },
      {
        name: "description",
        content:
          "Smart Gen School delivers world-class CBSE & State Board education through innovation, discipline, creativity, and holistic development.",
      },
      { name: "author", content: "Smart Gen School" },
      { property: "og:title", content: "Smart Gen School" },
      {
        property: "og:description",
        content:
          "World-class education through innovation, discipline, creativity, and holistic development.",
      },
